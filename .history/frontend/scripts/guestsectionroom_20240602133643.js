$(document).ready(function() {
    ...
    function displayRooms(page) {
        ...
        paginatedRooms.forEach(room => {
            // Ensure price_per_night is a number
            let pricePerNight = parseFloat(room.price_per_night);
            if (isNaN(pricePerNight)) {
                console.error('Invalid price_per_night for room:', room);
                pricePerNight = 0; // or handle the error appropriately
            }
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">$${pricePerNight.toFixed(2)} per night</p>
