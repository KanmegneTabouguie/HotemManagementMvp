...
router.get('/users/:id', adminMiddleware,cacheMiddleware(30), userController.getUserById);

// Get all users (admin-only route)
router.get('/users', adminMiddleware,cacheMiddleware(30), userController.getAllUsers);
