...
router.get('/rooms', authMiddleware,cacheMiddleware(30), roomController.listAvailableRooms); // Cache for 30 seconds

// Get room by ID (accessible to both guests and admins)
router.get('/rooms/:id', authMiddleware,cacheMiddleware(30), roomController.getRoomById); // Cache for 30 seconds
